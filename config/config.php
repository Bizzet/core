 ...
 * BASIC
 */
$config['site_title'] = 'Brennan Hampton';              // Site title
 ...
 * THEME
 */
$config['theme'] = 'brennanhampton';                // Set the theme (defaults to "default")
...
$config['content_dir'] = 'content-brennanhampton/';  // Content directory
