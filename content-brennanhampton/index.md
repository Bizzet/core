...
social:
    ...
    - title: Join us on Freenode IRC Webchat
      ...
      icon: chat
---
<section class="portfolio section fp-auto-height-responsive">
<div class="portfolio__wrapper">

<h2>My Work</h2>
<div class="portfolio__nav ">
    <div class="portfolio__entry">1 One</div>
    <div class="portfolio__entry">2 Two</div>
    <div class="portfolio__entry">3 Three</div>
    <div class="portfolio__entry">4 Four</div>
    <div class="portfolio__entry">5 Five</div>
    <div class="portfolio__entry">6 Six</div>
</div>
</div>
</section>
`##Creating Content`
...
database to deal with. You simply create `.md` 'iles in the `content` folder
